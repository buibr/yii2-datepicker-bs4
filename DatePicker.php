...
class DatePicker extends InputWidget
{
     ...
     * Please refer to the [Datepicker options](http://eonasdan.github.io/bootstrap-datetimepicker/Options/) web page
     * for possible options.
     */
    public $clientOptions = [];
    
    /**
     * @var array the default options for the Bootstrap DatePicker plugin. Widget will merge [[clientOptions]] with
     *      [[defaultClientOptions]]. Please refer to the [Datepicker
     *      options](http://eonasdan.github.io/bootstrap-datetimepicker/Options/) web page for possible options.
     */
     ...
     * Please refer to the [Datepicker events](http://eonasdan.github.io/bootstrap-datetimepicker/Events/) web page for
     * possible events.
     *
     * ~~~
     * [
